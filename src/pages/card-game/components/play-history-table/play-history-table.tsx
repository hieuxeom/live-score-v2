...
const PlayHistoryTable = ({roomInfo, playHistory, historyScoreBoard}: PlayHistoryTableProps) => {
    ...
    return (
        ...
        >
            ...
            >
                <TableWrapper className={"table-fixed border-2 border-primary border-collapse w-full"}>
                    <TableHeader>
                        <TableRow>
                            <TableCell
                                isHeader
                                borderType={"full"}
                                className={clsx("w-1/4 border-primary")}
                            >
                                <Typography
                                    type={"h4"}
                                    ...
                                    <div className={"flex lg:flex-row flex-col items-center lg:justify-center"}>
                                        ...
                                        {roomInfo.created_by === cookies.user_id && (
                                            <Button
                                                ...
                                                variant={"light"}
                                                color={"danger"}
                                                className={"lg:absolute lg:top-1/2 lg:left-2 lg:-translate-y-1/2"}
