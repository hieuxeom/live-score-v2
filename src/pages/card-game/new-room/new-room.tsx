...
const NewRoom = () => {
    ...
    useEffect(() => {
        socket.on(SOCKET_EVENT_NAMES.CREATE_NEW_ROOM.RECEIVE, (response: TGameCardSocketRoomCreated) => {
            ...
            return navigate(ROUTE_PATH.GAME_ROOM(response.newRoomId));
        });
    }, []);
    ...
    return (
        ...
        >
            <div className={"w-full px-4 flex flex-col justify-center items-center gap-4"}>
                <div
                    className={clsx(
                        "w-full bg-white shadow-primary-1 rounded-2xl flex flex-col gap-4 py-8",
                        "lg:w-3/4 lg:p-8"
                    )}
                >
                    <Typography
                ...
                <div className={clsx("w-full flex flex-col gap-4", "lg:w-3/4 lg:grid lg:grid-cols-3 ")}>
                    <div
                        className={clsx(
                            "w-full p-4 bg-white shadow-secondary-1 rounded-2xl flex flex-col gap-4",
                            "lg:px-8 lg:py-4"
                        )}
                    >
                        <Typography
